...
var getDefaultConfig = function(application) {
    ...
    return {
        ...
        //
        specs: [
            `./tests/bdd/${application._id}/features/**/*.feature`
        ],
        // Patterns to exclude.
        exclude: [
    ...
    cucumberOpts: {
        require: [`./tests/bdd/${application._id}/features/step-definitions`],        // <string[]> (file/dir) require files before executing features
